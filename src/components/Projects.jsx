        ...
        <AnimatePresence>
          {selectedProject && (
            <motion.div 
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-8 overflow-y-auto"
            ...
            >
              <motion.div 
                ...
                animate={{ scale: 1 }}
                exit={{ scale: 0.9 }}
                className="bg-white/10 rounded-xl max-w-4xl w-full grid md:grid-cols-2 overflow-hidden relative max-h-[90vh]"
              ...
              >
                ...
                <div className="p-8 text-white flex flex-col">
                  <h2 className="text-3xl mt-5 font-bold mb-4 flex items-center justify-between">
                    {selectedProject.name}
                 
                  </h2>
                  <p className="text-gray-300 mb-6 flex-grow overflow-y-auto">
                ...
                <button 
                  onClick={() => setSelectedProject(null)}
                  className="absolute top-2 right-4 text-white hover:text-red-500 transition-colors"
                >
                  Close (X)
                </button>
              </motion.div>
