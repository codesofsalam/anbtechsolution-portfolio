...
const WhyChooseUs = () => {
  const features = [
    ...
    },
    {
      ...
      title: "Quality",
      description:
        "Exceptional craftsmanship in every digital product we create.",
      color: "bg-purple-500",
    },
    {
      icon: Shield,
      title: "Reliability",
      description:
        "Consistent delivery and unwavering commitment to client success.",
      color: "bg-green-500",
    },
    {
      icon: Zap,
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="text-base md:text-xl text-gray-300 max-w-2xl mx-auto">
            Transforming challenges into opportunities through expert digital
            solutions
          </p>
        </motion.div>
